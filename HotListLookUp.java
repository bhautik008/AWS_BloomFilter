...
public class HotListLookUp {
	...
	public static void main(String[] args) throws Exception {
		...
		String filePath2 = otherArgs[2] ;
		Path value2 = new Path(filePath2);
		FileSystem.get(value2.toUri(),conf).delete(new Path(otherArgs[2]), true);
		Job job = new Job(conf, "Bloom Filtering Lookup");
		job.setJarByClass(HotListLookUp.class);
		...
		DistributedCache.addCacheFile(new Path("s3n://bloomfilter570/trainingbigoutput/hotlist.blm").toUri(), job.getConfiguration());
